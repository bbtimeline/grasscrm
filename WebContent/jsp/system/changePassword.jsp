	...
	<div id="page-wrap">
	    ...
	    <div id="feature">
			...
			<div id="shortcuts" class="headerList">
				<span> 
				  <span style="white-space: nowrap;"> <a id="change_btn" href="#"
						class="easyui-linkbutton" iconCls="icon-update" onclick="changePasswordForm.submit();"
			...
			<div id="feature-content">
				<s:form id="changePasswordForm" validate="true" action="changePassword" namespace="/jsp/system"
					method="post">
