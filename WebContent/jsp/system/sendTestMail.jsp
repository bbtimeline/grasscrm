		...
		<div id="feature-content">
			<s:form id="sentTestMailForm" action="sendEmail" method="POST" namespace="/jsp/system">
				<table style="width: 100%;" border="0">
					...
					<tr>
						<td style="width: 50%;"><s:text name="emailSetting.test_email_address.label" />:</td>
						<td style="text-align: left;">
						  <s:textfield name="emailAddress" cssClass="record-value" />
						</td>
					</tr>
					<tr>
						<td><br></td>
					...
					<tr>
						<td style="text-align: left;"><span
							style="white-space: nowrap;"> <a href="#"
								class="easyui-linkbutton" iconCls="icon-mail" onclick="submit()"
