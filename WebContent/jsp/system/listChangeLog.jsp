		...
		<div id="feature">
		  ...
		  <div id="shortcuts" class="headerList">
			...
			<span> 
			  <s:if test="#session.loginUser.delete_system == 1">	
				<span style="white-space: nowrap;"> 
				  <a id="delete" href="#" class="easyui-linkbutton" iconCls="icon-remove" plain="true"><s:text name="action.deleteChangeLog" /></a>
				</span> 
			  </s:if>	
			 </span>
		  </div>
			...
			<div id="feature-content">
	          ...
	          <div id="filter" style="margin-left:30%;display:none"><s:text name="title.listChangeLog" /></div>
		    </div>
     	  </div>
