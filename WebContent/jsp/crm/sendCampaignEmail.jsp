	...
	<div id="page-wrap">
	    ...
	    <div id="feature">
			...
			<div id="shortcuts" class="headerList">
				<span style="white-space: nowrap;" id="send_span"> <a id="send_btn" href="#"
						class="easyui-linkbutton" iconCls="icon-mail" onclick="send()"
						plain="true"><s:text name="button.send" /></a>
					...
					<table style="" cellspacing="10" cellpadding="0" width="100%">
 					...
 					<table style="padding: 10px;" cellspacing="10" cellpadding="0"
						...
						<tr>
							...
							<td><s:textfield name="from" cssClass="record-value" size="80"/></td>
						</tr>						
						<tr>
							<td class="td-label"><label class="record-label"><s:text
										name="emailTemplate.to.label"></s:text>：</label></td>
							<td>
							<s:textarea name="to" rows="1" cssClass="record-value" cssStyle="width:900px;overflow:scroll;overflow-y:hidden;overflow-x:hidden" onfocus="window.activeobj=this;this.clock=setInterval(function(){activeobj.style.height=activeobj.scrollHeight+'px';},200);" onblur="clearInterval(this.clock);"/>
							</td>
						</tr>
						<tr>
							<td class="td-label"><label class="record-label"><s:text
							...
							<td>
								...
								<a id="select_template_btn" href="#" class="easyui-linkbutton" iconCls="icon-search" onclick="selectTemplate()" plain="true"><s:text name="action.select" /></a>
							  </span>
						    </td>
						</tr>												
						<tr>
							...
							<td>
							  <span id="spanCampaign"> 
								<select id="variableCampain" name="variableCampain" style="width:150px;">  
								    <option value="$campaign.start_date"><s:text name="entity.campaign.label" />.<s:text name="entity.start_date.label" /></option>  
						...
						<tr>
							...
							<td><s:textfield name="subject" cssClass="record-value" size="80"/></td>
						</tr>
						<tr>
							<td class="td-label"><label class="record-label"><s:text
										name="emailTemplate.text_only.label"></s:text>：</label></td>
							<td><s:checkbox id="text_only"
									name="text_only" cssClass="record-value"/></td>
						</tr>
						<tr>
							<td class="td-label"><label class="record-label"><s:text
							...
							<td>
                               <span id="ckeditor">
                                 <s:textarea id="html_body" rows="30" cols="100" cssClass="record-value" name="html_body"/>
                                 <script type="text/javascript">CKEDITOR.replace('html_body');</script>
                               </span>
                               <span id="texteditor">
