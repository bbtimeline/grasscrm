		...
		<div id="feature">
			...
			<div id="shortcuts" class="headerList">
				...
				<span> <span style="white-space: nowrap;"> <a id="save_go_btn" href="#"
						...
						plain="true"><s:text name="button.convertToLead" /></a>						
				...
				<s:if test="target!=null && target.id!=null">
				    <span style="white-space: nowrap;"><a
						...
						<div id="mtm1" style="width: 150px;">
						  <div data-options="iconCls:'icon-import'" onClick="openwindow2('/crm/showChangeLogPage.action?entity=Target&recordID=' + '<s:property value="target.id" />',750,500)">
				...
				<s:form id="addObjectForm" validate="true" namespace="/jsp/crm"
					...
					<table style="padding: 10px;" cellspacing="10" cellpadding="0"
						...
						<tr>
							...
							<td class="td-value"><input id="last_name" name="target.last_name"
								class="easyui-validatebox record-value"
								data-options="required:true"
								value="<s:property value="target.last_name" />" /></td>
						    <td class="td-mass-update"><input id="massUpdate"
										name="massUpdate" type="checkbox" class="massUpdate" value="company"/></td>							
							<td class="td-label"><label class="record-label"><s:text
										name="entity.company.label"></s:text>：</label></td>
							<td class="td-value"><s:textfield name="target.company"
									cssClass="record-value" /></td>
						</tr>
						...
						<s:if test="lead!=null">
						  <tr>
							...
							<td class="td-value">
							  <a href="<s:url value='editLead.action?id=%{lead.id}'/>"><s:property value="lead.name"/></a>
							</td>
						    <td class="td-mass-update"></td>							
						...
						<div title="<s:text name='tab.overview'/>" style="padding: 10px;">
							...
							<table style="" cellspacing="10" cellpadding="0" width="100%">
								<tr>
									...
									<td class="td-value"><s:textfield
											name="target.primary_street" cssClass="record-value" /></td>
						            <td class="td-mass-update"><input id="massUpdate"
							...
							<table style="" cellspacing="10" cellpadding="0" width="100%">
								<tr>
									...
									<td class="td-value" valign="top"><s:textarea
											name="target.description" rows="20" cssStyle="width:450px;"
											cssClass="record-value" /></td>
						            <td class="td-mass-update"><input id="massUpdate"
									...
									<td class="td-value" valign="top"><s:textarea
											name="target.notes" rows="20" cssStyle="width:450px;"
											cssClass="record-value" /></td>
								</tr>
							</table>
