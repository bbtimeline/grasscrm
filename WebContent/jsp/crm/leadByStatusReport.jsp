		  ...
		  <div id="shortcuts" class="headerList">
			...
			<span> 
				<span style="white-space: nowrap;"> 
				   <a href="leadByStatusReportPage.action" class="easyui-linkbutton" iconCls="icon-pie" plain="true"><s:text name="action.report.pie" /></a>
				</span> 
				<span style="white-space: nowrap;"> 
				   <a href="leadByStatusBar.action" class="easyui-linkbutton" iconCls="icon-bar" plain="true"><s:text name="action.report.bar" /></a>
				</span> 								
			</span>
		   </div>
