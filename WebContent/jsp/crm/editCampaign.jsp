				...
				<s:if test="campaign!=null && campaign.id!=null">
				    <span style="white-space: nowrap;"><a
						...
						<div id="mtm1" style="width: 150px;">
						  <div data-options="iconCls:'icon-import'" onClick="openwindow2('/crm/showChangeLogPage.action?entity=Campaign&recordID=' + '<s:property value="campaign.id" />',750,500)">
					...
					<div id="tt" class="easyui-tabs">
						<div title="<s:text name='tab.overview'/>" style="padding: 10px;">
							<table style="" cellspacing="10" cellpadding="0" width="100%">
								...
								<tr>
						            <td class="td-mass-update"><input id="massUpdate"
										        name="massUpdate" type="checkbox" class="massUpdate" value="expected_respone"/></td>
									<td class="td-label"><label class="record-label"><s:text
						...
						<div title="<s:text name='tab.details'/>" style="padding: 10px;">
							...
							<table style="" cellspacing="10" cellpadding="0" width="100%">
								<tr>
									...
									<td class="td-value" valign="top"><s:textarea
											name="campaign.notes" rows="20" cssStyle="width:450px;"
											cssClass="record-value" /></td>
								</tr>
							</table>
