		  ...
		  <div id="shortcuts" class="headerList">
			...
			<span> 
				<span style="white-space: nowrap;"> 
				   <a href="accountReportPDF.action" class="easyui-linkbutton" iconCls="icon-export" plain="true"  target="_blank"><s:text name="action.export.pdf" /></a>
				</span> 
				<span style="white-space: nowrap;"> 
				   <a href="accountReportExcel.action" class="easyui-linkbutton" iconCls="icon-export" plain="true"><s:text name="action.export.excel" /></a>
				</span> 
				<span style="white-space: nowrap;"> 
				   <a href="accountReportCSV.action" class="easyui-linkbutton" iconCls="icon-export" plain="true"><s:text name="action.export.csv" /></a>
				</span> 								
			</span>
		   </div>
