				...
				<s:if test="targetList!=null && targetList.id!=null">
				    <span style="white-space: nowrap;"><a
						...
						<div id="mtm1" style="width: 150px;">
						  <div data-options="iconCls:'icon-import'" onClick="openwindow2('/crm/showChangeLogPage.action?entity=TargetList&recordID=' + '<s:property value="targetList.id" />',750,500)">
