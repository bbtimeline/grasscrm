				...
				<s:if test="document!=null && document.id!=null">
				    <span style="white-space: nowrap;"><a
						...
						<div id="mtm1" style="width: 150px;">
						  <div data-options="iconCls:'icon-import'" onClick="openwindow2('/crm/showChangeLogPage.action?entity=Document&recordID=' + '<s:property value="document.id" />',750,500)">
						...
						<div title="<s:text name='tab.descriptions'/>"
							...
							<table style="" cellspacing="10" cellpadding="0" width="100%">
								<tr>
									...
									<td class="td-value" valign="top"><s:textarea
											name="document.notes" rows="20" cssStyle="width:450px;"
											cssClass="record-value" /></td>
								</tr>
							</table>
