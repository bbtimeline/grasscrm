...
public class CalendarAction extends ActionSupport {
    ...
    private static final String CLAZZ = CalendarAction.class.getSimpleName();
    ...
    public String getCalendarInfo() throws Exception {
        ...
        StringBuilder hqlBuilder = new StringBuilder(
                "select subject,start_date,description from Call call where start_date>=? and start_date<?");
        ...
        while (calllIter.hasNext()) {
            ...
            calendarVO.setDescription(CommonUtil.fromNullToEmpty(description));
        ...
        hqlBuilder = new StringBuilder(
                "select subject,start_date,end_date,location,description from Meeting meeting where start_date>=? and start_date<?");
        ...
        while (meetingIter.hasNext()) {
            ...
            descriptionBuilder.append(CommonUtil.fromNullToEmpty(location))
                    .append("\n")
                    .append(CommonUtil.fromNullToEmpty(description));
            calendarVO.setSubject(subject);
            calendarVO.setStartDate(startDate.getTime());
        ...
        hqlBuilder = new StringBuilder(
                "select subject,start_date,due_date,description from Task task where start_date>=? and start_date<?");
